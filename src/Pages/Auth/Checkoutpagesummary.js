  ...
  return (
    <div>
      ...
      <div className="mainn-main-cont">
        ...
        <div className="peee-main-container">
          <div className="pe-container">
            <div className="hold-two">
              <div className="first-payment-cont">Payment</div>
              <div className="star-container">*********897</div>
            </div>
            <div className="hold-dit-date">
              <div className="dit-cont">Edit</div>
              <div className="date-para">MM/YY</div>
            </div>
          </div>
        </div>
        <div className="ship-mainnn-container">
          <div className="main-ship--container">
            <div className="hold-three">
              <div className="shippp-container">Shipping Address</div>
              <div className="ame-cont">Name</div>
              <div className="countryy-cont">Country</div>
            </div>
            <div className="hold-lawrence-cont">
              <div className="hold-lawrence">Edit</div>
              <div className="king">lawrence kingsley</div>
              <div className="alba">Albania</div>
            </div>
          </div>
        </div>
        <div className="order-maiiin-conta">
          <div className="order-container">
            <div color="hold-four">
              <div className="O-S">Order Summary</div>
              <div className="sub-cont">sub total </div>
              <div className="dev-cont">delivery </div>
              <div className="grand-container"> Grand Total </div>
            </div>
            <div className="three-holdd-cont">
              <div className="price-one">$4,200 </div>
              <div className="price-one">$200</div>
              <div className="price-two">$4,400</div>
            </div>
          </div>
        </div>

        <div className="btn-contaaaainer">
          <button className="subbbbmit-btn">Submit Order</button>
        </div>
      </div>
    </div>
  );
