...
function Checkoutpageform() {
  return (
    <div>
      ...
      <div className="cchoose-container">Choose a payment method</div>
      <div className="cccharged-container">
        You will not be charged until you confirm your order on the next page
      </div>
      <div className="credt-card-container">
        <div className="cccc-container">
          {" "}
          <svg
            width="21"
            height="22"
      ...
      <div className="checkout-formmmm container">
        <form className="form-conttttt">
          <input
            placeholder="Name on Card"
            type="text"
            name="name on card"
            className="chhhheckout-input-field"
          />
